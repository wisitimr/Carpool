            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
              ...
              <div className="flex w-full gap-2 sm:w-auto">
                <button
                  ...
                  className="flex-1 rounded-xl bg-green-600 px-4 py-2.5 text-sm font-medium text-white transition hover:bg-green-700 active:scale-[0.98] disabled:opacity-50 sm:flex-none sm:py-2"
                >
                ...
                <button
                  ...
                  disabled={isAnyLoading}
                  className={`shrink-0 rounded-xl border px-3 py-2.5 text-sm font-medium transition active:scale-[0.98] disabled:opacity-50 sm:py-2 ${
                    isExpanded
